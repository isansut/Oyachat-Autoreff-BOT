...
async function createEmail() {
    try {
        ...
        console.log("⚠️ Gagal membuat email, melanjutkan ke akun berikutnya...");
        return null;
    }
}
...
async function getOTP(email) {
    try {
        ...
        console.log("⚠️ Gagal mendapatkan OTP, melanjutkan ke akun berikutnya...");
        return null;
    }
}
...
async function registerOyaChat(email, referralCode) {
    try {
        ...
        if (!otp) {
            console.log("⚠️ Gagal mendapatkan kode OTP, melanjutkan ke akun berikutnya...");
            await browser.close();
            return;
        }
        ...
        console.log("⚠️ Terjadi kesalahan saat mendaftar, melanjutkan ke akun berikutnya...");
    }
}
